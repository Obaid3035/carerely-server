...
let FriendShipService = class FriendShipService extends base_service_1.default {
    constructor() {
        super(FriendShip_1.default);
    }
    ...
    unFollowFriendship(friendShipId) {
        return __awaiter(this, void 0, void 0, function* () {
            const friendShip = yield FriendShip_1.default.findOne(friendShipId);
            if (!friendShip) {
    ...
    sendFriendShipRequest(sender, receiverId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const receiver = yield User_1.default.findOne(receiverId);
            if (!receiver) {
    ...
    acceptFriendShipRequest(receiver, senderId) {
        return __awaiter(this, void 0, void 0, function* () {
            const sender = yield User_1.default.findOne(senderId);
            if (!sender) {
                throw new errorCode_1.NotFound("User not found");
            }
