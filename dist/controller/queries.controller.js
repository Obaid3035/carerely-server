    ...
    constructor() {
        ...
        this.createAnswer = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = req.user;
                const queriesServiceInstance = typedi_1.Container.get(QueriesService_1.default);
                const answer = yield queriesServiceInstance.createAnswer(parseInt(queriesId), user.id, req.body);
        ...
        this.create = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = req.user;
                const queriesServiceInstance = typedi_1.Container.get(QueriesService_1.default);
                const topic = yield queriesServiceInstance.create(parseInt(topicId), user.id, req.body);
                res.status(http_status_codes_1.StatusCodes.CREATED).json(topic);
            }
            catch (e) {
                next(e);
