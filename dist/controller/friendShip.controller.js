    ...
    constructor() {
        ...
        this.unFollowFriendship = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const { deleted } = yield friendShipInstance.unFollowFriendship(parseInt(friendShipId));
                res.status(200).json({
                    deleted
                });
            }
        ...
        this.sendFriendShipRequest = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const friendShipInstance = typedi_1.Container.get(FriendShipService_1.default);
                const { saved, status } = yield friendShipInstance.sendFriendShipRequest(sender, parseInt(receiverId));
        ...
        this.acceptFriendShipRequest = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const friendShipInstance = typedi_1.Container.get(FriendShipService_1.default);
                const { updated, status } = yield friendShipInstance.acceptFriendShipRequest(receiver, parseInt(senderId));
        ...
        this.declineFriendShipRequest = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const receiver = req.user;
                const friendShipInstance = typedi_1.Container.get(FriendShipService_1.default);
                const { deleted, status } = yield friendShipInstance.declineFriendShipRequest(receiver, parseInt(senderId));
                res.status(200).json({
                    deleted,
                    status
                });
