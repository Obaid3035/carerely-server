...
export class carelery1654866741257 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" SERIAL NOT NULL, "dob" date NOT NULL, "height_feet" integer NOT NULL, "height_inches" integer NOT NULL, "weight" double precision NOT NULL, "weight_unit" character varying NOT NULL, "gender" "profile_gender_enum" NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" integer NOT NULL, CONSTRAINT "REL_d752442f45f258a8bdefeebb2f" UNIQUE ("user_id"), CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" SERIAL NOT NULL, "user_name" character varying(25) NOT NULL, "email" character varying(50) NOT NULL, "password" character varying NOT NULL, "role" "user_role_enum" NOT NULL, "profile_setup" boolean NOT NULL DEFAULT false, "image" text, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "notification_status_enum" AS ENUM('like', 'comment', 'follow')`);
        await queryRunner.query(`CREATE TABLE "notification" ("id" SERIAL NOT NULL, "sender_id" integer NOT NULL, "receiver_id" integer NOT NULL, "status" "notification_status_enum" NOT NULL, "seen" boolean NOT NULL DEFAULT false, "post_id" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_705b6c7cdf9b2c2ff7ac7872cb7" PRIMARY KEY ("id"))`);
